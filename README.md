...
[![Test](https://github.com/garycarr/pdfcpu/workflows/Test/badge.svg)](https://github.com/garycarr/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/garycarr/pdfcpu?status.svg)](https://pkg.go.dev/github.com/garycarr/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/garycarr/pdfcpu)](https://goreportcard.com/report/github.com/garycarr/pdfcpu)
...
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/garycarr/pdfcpu/releases)
...
* [API tests](https://github.com/garycarr/pdfcpu/tree/master/pkg/api/test)
* [API samples](https://github.com/garycarr/pdfcpu/tree/master/pkg/samples) 
* CLI usage: `$ pdfcpu help cmd`

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/garycarr/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/garycarr/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/garycarr/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/garycarr/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/garycarr/pdfcpu
...
```
$ go install github.com/garycarr/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/garycarr/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/garycarr/pdfcpu/discussions) first or [create](https://github.com/garycarr/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/garycarr/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
